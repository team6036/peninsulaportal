...
export default class CSVFieldSource extends Source {
    #data;
    ...
    async build() {
        ...
        this.clear();
        const client = new WorkerClient("../sources/csv/field/decoder-worker.js");
    ...
    static async export(source, prefix="") {
        ...
        const client = new WorkerClient("../sources/csv/field/encoder-worker.js");
        return await new Promise((res, rej) => {
            client.addHandler("error", e => rej(e));
            client.addHandler("stop", data => rej("WORKER TERMINATED"));
