...
const NUMBERS = exports.NUMBERS = "0123456789";
const ALPHABETUPPER = exports.ALPHABETUPPER = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
const ALPHABETLOWER = exports.ALPHABETLOWER = ALPHABETUPPER.toLowerCase();
const BASE64 = exports.BASE64 = ALPHABETLOWER+ALPHABETUPPER+NUMBERS+"-_";

const MAGIC = exports.MAGIC = "_*[[;ƒ";

const UTILVERSION = exports.UTILVERSION = 1;
...
function ensure(o, type, def=ENSURE_NONE) {
    let typefs = {
        num: () => {
...
class V {
    ...
    rotate(d, o) {
        o = new V(o);
        return this.sub(o).rotate(d).add(o);
    }
...
exports.Circle = Shape.Circle = Circle;

class InvertedCircle extends Circle {
    constructor(...a) {
        super(...a);
    }
...
exports.InvertedCircle = Shape.InvertedCircle = InvertedCircle;
...
exports.Polygon = Shape.Polygon = Polygon;
